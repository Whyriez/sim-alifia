                ...
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item mx-5">
                        <a class="nav-link  text-center" href="#">
                            <img src="assets/img/potensiDesa.svg" width="80" alt="Menu 2"
                                class="img-fluid">
                    ...
                    <li class="nav-item mx-5">
                        <a class="nav-link  text-center" href="#">
                            <img src="assets/img/pembangunanDesa.svg" width="80" alt="Menu 3"
                                class="img-fluid">
                    ...
                    <li class="nav-item mx-5">
                        <a class="nav-link  text-center" href="#">
                            <img src="assets/img/keuanganDesa.svg" width="80" alt="Menu 3"
                                class="img-fluid">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="d-flex mb-4">
                        ...
                        <div style="margin-left: 1.25rem;">
                            <h3 class="text-primary mb-2">Judul List</h3>
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius corrupti autem vero provident
                                veritatis repellat perferendis animi porro nisi, voluptas aspernatur, sequi distinctio!
                                Necessitatibus dicta nam quam dolorem. Hic, quaerat.
                            </p>
                        </div>
                    </div>
                    <div class="d-flex mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class=" mt-3">
                        ...
                        <div class="d-flex mb-4">
                            <div
                                class="bg-primary w-25 text-white fw-bold d-flex justify-content-center align-items-center">
                                Oct 15 2021</div>
                            <div style="margin-left: 1.25rem;">
